...
Nino Djordjević – v imenu Podjetniškega kluba FMF
  ...
  {
    id: "15",
    title: "Matej Berger in Domen Balantič – Kriptal",
    slug: "matej-berger-domen-balantic-kriptal",
    author: "Nino Djordjević",
    date: "2025-05-26",
    excerpt:
      "V ponedeljek, 26. maja, smo na 7. dogodku Podjetniškega kluba FMF gostili ustanovitelja podjetja Kriptal – Mateja Bergerja in Domna Balantička. V dveh urah smo se z njima podali na izjemno zanimivo podjetniško in tehnološko potovanje skozi svet kriptovalut, algoritmičnega trgovanja in finančne logike.",
    coverImage: "/images/og-image.png",
    category: "Dogodki",
    content: `
# 7. dogodek Podjetniškega kluba FMF: V svetu kripta z Matejem Bergerjem in Domenom Balantičem
...
Z Matejem in Domenom smo se pogovarjali tudi o osnovah financ – kaj pomeni longati in shortati, kaj so market makerji in kako delujejo likvidnostni mehanizmi v decentraliziranem okolju. Skozi konkretne primere sta pojasnila kompleksne pojme na razumljiv način, kar je še posebej koristilo tistim, ki se šele spoznavamo s tem hitro rastočim področjem.

## Zaključek
Dogodek je trajal dve uri, a bi lahko poslušali še dlje – toliko zanimivih vpogledov sta nam ponudila gosta.

Iskrena hvala Mateju in Domenu za obisk, odprt pogovor in vse dragocene nasvete!

V imenu Podjetniškega kluba FMF,  
Nino Djordjević
    `,
    seoDescription:
      "Poročilo s sedmega dogodka Podjetniškega kluba FMF z Matejem Bergerjem in Domenom Balantičem iz Kriptal, kjer sta delila izkušnje iz sveta kriptovalut in algoritmičnega trgovanja.",
    seoKeywords:
      "Matej Berger, Domen Balantič, Kriptal, Podjetniški klub FMF, kriptovalute, algoritmično trgovanje, finančni trgi, arbitraža, market makerji",
  }
];
